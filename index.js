    ...
    doxyparser.loadIndex(options, function(err, root)
    {
      ...
      if (options.groups)
      {
        ...
        groups.forEach(function(group)
        {
          ...
          helpers.writeCompound(group, templates.renderArray(compounds),
      ...
      else if (options.classes)
      {
        ...
        rootCompounds.forEach(function(comp)
        {
          ...
          helpers.writeCompound(comp, [ templates.render(comp) ],
                                doxyparser.references, options);
          ...
          compounds.forEach(function(e)
          {
            ...
            helpers.writeCompound(e, [ templates.render(e) ],
                                  doxyparser.references, options);
          });
        });
      }
      ...
      if (options.pages)
      {
        ...
        pages.forEach(function(page)
        {
          ...
          helpers.writeCompound(page, templates.renderArray(compounds),
                                doxyparser.references, options);
        });
      }
    });
